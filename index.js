...
home.addEventListener("mouseover", () => {
        long1.style.top = "60px"; // Atualiza o estilo diretamente
...
about.addEventListener("mouseover", () => {
    long2.style.top = "60px"; // Atualiza o estilo diretamente
...
long2.addEventListener("mouseout", () => {
    long2.style.top = "-22px"; // Restaura o estilo original
...
shop.addEventListener("mouseover", () => {
    long3.style.top = "60px"; // Atualiza o estilo diretamente
...
long3.addEventListener("mouseout", () => {
    long3.style.top = "-10px"; // Restaura o estilo original
...
language.addEventListener("mouseover", () => {
    long4.style.top = "60px"; // Atualiza o estilo diretamente
...
long4.addEventListener("mouseout", () => {
    long4.style.top = "-10px"; // Restaura o estilo original
...
contact.addEventListener("mouseover", () => {
    long5.style.top = "60px"; // Atualiza o estilo diretamente
...
long5.addEventListener("mouseout", () => {
    long5.style.top = "-10px"; // Restaura o estilo original
